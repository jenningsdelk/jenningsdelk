...
### 🛥️ [Pantanal Cruise - Barco Hotel](https://github.com/jenningsdelk/pantanal-cruise)
Site institucional em fase de desenvolvimento, criado para um **barco hotel no Pantanal**, com foco em **design limpo, responsivo e imersivo**, destacando os serviços de **safári fotográfico e pesca esportiva**.  

> Tecnologias: HTML, CSS, JavaScript, TailwindCSS, Responsividade, SEO básico

---

## 📂 Outros Projetos  
*(Em breve serão adicionados novos projetos com foco em automações, sistemas web e APIs)*  

🔹 [Nome do Projeto 1](#) — descrição breve  
🔹 [Nome do Projeto 2](#) — descrição breve  
🔹 [Nome do Projeto 3](#) — descrição breve
# 📊 GitHub Stats:
